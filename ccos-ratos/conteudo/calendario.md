...
|---|---|---|---|---|---|---|
| | | Tastto | conteudo/tastto/carrosseis/delivery-x-fidelizacao/instagram/ (carrossel, 5 slides) | "No delivery, todo pedido parece uma vitória. Mas pedido é transação, cliente é ativo..." | pronto | |
| | | Arttico | conteudo/arttico/carrosseis/atualizacoes-api-oficial/instagram/ (carrossel, 3 slides) | "A Meta mudou a lógica de cobrança da API oficial do WhatsApp..." | pronto | |
